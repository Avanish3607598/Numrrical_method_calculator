...
public class method1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bisection Method");
        ...
        jLabel6.setText("Enter Interval");

        jLabel7.setFont(new java.awt.Font("Serif", 1, 16)); // NOI18N
        jLabel7.setText("Approximate Root");
        ...
        jTextField7.setBackground(new java.awt.Color(140, 140, 140));
        ...
        jLabel8.setText("Enter number of stage");
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        try {
            if (evt.getSource() == jButton4) {
                ...
                double a, b, c, d, m, n, fx1, fx2, fx3;
                double root;
                int t;
                ...
                m = Double.parseDouble(jTextField5.getText());
                n = Double.parseDouble(jTextField6.getText());
                System.out.println(a + "" + b + "" + c + "" + d + "" + m + "" + n);

                fx1 = a * m * m * m + b * m * m + c * m + d;

                fx2 = a * n * n * n + b * n * n + c * n + d;
                ...
                if (fx1 * fx2 >= 0) {
                    ...
                    for (int i = 1; i <= t; i++) {
                        ...
                        jTextField7.setText(Double.toString(x0));
                    }
                }
